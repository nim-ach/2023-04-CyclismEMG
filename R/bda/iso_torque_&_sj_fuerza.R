...
quad_model <- brm(
  ...
  formula = mean_torque_quad | se(sd_torque_quad) ~ jump_sj_fuerza_peak,
...
saveRDS(quad_model, file = "R/bda/bm/quad_iso_torque_&_sj_fuerza.RDS")
...
get_prior(formula = mean_torque_isquio | se(sd_torque_isquio) ~ jump_sj_fuerza_peak, data = isqt_data)

isqt_model <- brm(
  ## Especificamos el modelo
  formula = mean_torque_isquio | se(sd_torque_isquio) ~ jump_sj_fuerza_peak,
...
saveRDS(isqt_model, file = "R/bda/bm/isquios_iso_torque_&_sj_fuerza.RDS")
